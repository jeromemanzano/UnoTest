...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SkiaSharp.Views.Windows.GLTextureView, SkiaSharp.Views.Windows", GLTextureView.class, __md_methods);
	}
	...
	public GLTextureView (android.content.Context p0)
	{
		...
		if (getClass () == GLTextureView.class)
			mono.android.TypeManager.Activate ("SkiaSharp.Views.Windows.GLTextureView, SkiaSharp.Views.Windows", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public GLTextureView (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == GLTextureView.class)
			mono.android.TypeManager.Activate ("SkiaSharp.Views.Windows.GLTextureView, SkiaSharp.Views.Windows", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public GLTextureView (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == GLTextureView.class)
			mono.android.TypeManager.Activate ("SkiaSharp.Views.Windows.GLTextureView, SkiaSharp.Views.Windows", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2 });
	}
	...
	public GLTextureView (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == GLTextureView.class)
			mono.android.TypeManager.Activate ("SkiaSharp.Views.Windows.GLTextureView, SkiaSharp.Views.Windows", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2, p3 });
	}
