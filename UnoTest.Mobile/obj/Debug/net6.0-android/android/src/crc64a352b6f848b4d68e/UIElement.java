...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.UI.Xaml.UIElement, Uno.UI", UIElement.class, __md_methods);
	}
	...
	public UIElement (android.content.Context p0)
	{
		...
		if (getClass () == UIElement.class)
			mono.android.TypeManager.Activate ("Microsoft.UI.Xaml.UIElement, Uno.UI", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
